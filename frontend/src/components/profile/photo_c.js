...
class PhotoCForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      id: this.props.userId,
      aboutMePicC: this.props.user.aboutMePicC,
      file: null
    };
  ...
  handleSubmit = async (e) => {
    ...
    await this.fileUploadHandler()
      .then((res) => {
        this.setState({ aboutMePicC: res.data.location });
      });
        ...
        <form onSubmit={this.handleSubmit} encType="multipart/form-data">
          ...
          <div className="picture-buttons">
            ...
            <button className="buttons"
              id="choose-pic"
              onClick={() => this.fileInput.click()}> Pick Photo C </button>
            <button className="buttons"
              id="upload-pic"
